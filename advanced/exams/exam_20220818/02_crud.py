...
curr_pos = tuple(input())
curr_row, curr_col = int(curr_pos[1]), int(curr_pos[4])
...
while True:
    ...
    if action == "Create":
        value = command[2]
        next_row, next_col = valid_position(curr_row, curr_col, direction)
...
[print(*matrix[r]) for r in range(6)]