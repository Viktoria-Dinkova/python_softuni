...
# print them on the console, separated by a comma and a space ", ". The input will be a string containing phone numbers and other symbols.
...
phone_book = re.findall(pattern, phones)
