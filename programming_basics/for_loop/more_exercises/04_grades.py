...
# между 2.00 и 2.99, между 3.00 и 3.99, между 4.00 и 4.99, 5.00 или повече. Също така и средният успех на изпита.
# Вход
...
print(f'Top students: { (exelant / count_students * 100):.2f}%')
print(f'Between 4.00 and 4.99: {(vgood / count_students * 100):.2f}%')
print(f'Between 3.00 and 3.99: {(good / count_students * 100):.2f}%')
print(f'Fail: {(fail / count_students * 100):.2f}%')
print(f'Average: {(allmark / count_students):.2f}')
